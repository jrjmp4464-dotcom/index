...
height: 100vh;
margin: 0;
background: url('https://scontent.fcvj2-2.fna.fbcdn.net/v/t39.30808-6/548978938_4075410586107059_8029837686134827748_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=833d8c&_nc_ohc=77SipXlS1dcQ7kNvwEQfVGQ&_nc_oc=Adm7PFEuWgrT3F1RYW9VfmrEiLNPzWTBUDv8SjjP6fUv_ddLUpIy-R46BmqtcyD9Asean3tw_xrp2p85ROuuprLJ&_nc_zt=23&_nc_ht=scontent.fcvj2-2.fna&_nc_gid=t6wCnOPhp1K926iNF_9MwQ&oh=00_AfbBKqhB36K8PvAE_8zRKvbxjDiMrxsKd5O8HNoaZJSpgw&oe=68DBC831') no-repeat center center;
...
/*mensaje centro y colores*/
.message {
background: rgba(235, 177, 106, 0.8);
padding: 15px;
border-radius: 15px;
...
.hearts:nth-child(5) { left: 85%; animation-duration: 10s; } /* Nuevo corazón */
...
.charming-text:nth-child(6) { top: 45%; right: 5%; text-align: right; animation-duration: 9s; } /* Nuevo texto */
...
.flowers:nth-child(6) { left: 60%; animation-duration: 11s; } /* Nueva flor */
...
.bubbles:nth-child(6) { left: 60%; animation-duration: 13s; } /* Nueva burbuja */
...
border-radius: 50px;
box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
animation: floatText 15s ease-in-out forwards;
white-space: nowrap;
}
...
width="480"
height="270"
src="https://www.youtube.com/watch?v=mxbsev38lLo&list=RDmxbsev38lLo&start_radio=1" 
frameborder="0" 
...
audio.play();        // Asegura la reproducción
}
